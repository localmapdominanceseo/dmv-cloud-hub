...
def render_home(data):
    ...
    return '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="google-site-verification" content="riDlcBSoLWztyINnTo3r-a3pBEL9VjUNgPJdL0xYfmg"><meta name="viewport" content="width=device-width,initial-scale=1"><title>DMV Hub | State-by-State DMV Guide Index</title><meta name="description" content="State-by-state DMV guide index for driver license renewal, REAL ID, replacements, and official DMV resources."><link rel="canonical" href="'+BASE_URL+'/"><link rel="stylesheet" href="/assets/css/style.css"></head><body><main class="page"><header class="hero"><div class="crumb">DMV Hub</div><h1>State-by-State DMV Guide Index</h1><p>Find driver license renewal, REAL ID, replacement, and official DMV resources by state.</p></header><section class="state-list">'+cards+'</section><div class="site-footer">DMV Hub is an independent guide index. Always verify requirements with your official state DMV.</div></main></body></html>'
